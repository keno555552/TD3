...
private:
  ...
  /// <summary>
  /// 胴体共有操作点の半径を取得する
  /// 見つからない場合は defaultRadius を返す
  /// </summary>
  float GetTorsoControlPointRadius(ModControlPointRole role,
  ...
  /// 見つからない場合は defaultRadius を返す
  /// </summary>
  float GetPartControlPointRadius(int partId, ModControlPointRole role,
                                  float defaultRadius) const;
